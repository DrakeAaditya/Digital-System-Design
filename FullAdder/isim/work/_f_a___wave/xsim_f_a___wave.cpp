#include "isim/work/_f_a___wave/_f_a___wave.h"
#include "isim/work/glbl/glbl.h"
static const char * HSimCopyRightNotice = "Copyright 2004-2005, Xilinx Inc. All rights reserved.";


#include "work/_f_a___wave/_f_a___wave.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workM_f_a___wave(label); 
    return blk;
}
...
#include "work/_full_adder/_full_adder.h"
static HSim__s6* IF7(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workM_full_adder(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("FA_Wave", (HSimInstFactoryPtr)IF0);
        ...
        (*cfgvh).addVlogModule("FullAdder", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF8);
        HSim__s5 * topvl = 0;
        topvl = new workM_f_a___wave("FA_Wave");
